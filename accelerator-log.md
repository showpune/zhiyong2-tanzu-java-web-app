...
```json
{
  "projectName" : "zhiyong2-tanzu-java-web-app",
  "repositoryPrefix" : "https://hub.docker.com/repository/docker/showpune/tanzu-test/"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->zhiyong2-tanzu-java-...(truncated)]
┃ ┃ ┃ ┃ ┃ ┏ engine.transformations[0].merge.transformations[0].sources[1].<combo>.transformations[1].transformations[1] (ReplaceText)
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->https://hub.docker.c...(truncated)]
